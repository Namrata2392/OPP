    ...
    public partial class frmOpenProPlus : Form
    {
        ...
        private void SaveXMLFiles()
        {
            ...
            try
            {
                ...
                //FolderPath: C:\Users\namrata\Desktop
                //XMLName: e.g: openproplus_config
                //string TarFile = DirName + ".tar.gz"=====    DirName: C:\Users\namrata\Desktop\7
                //DestDir: C:\Users\namrata\Desktop\7
                // CreateTar(TarFile, DestDir);
        ...
        private void SaveXMLSLDClientServer()
        {
            ...
            try
            {
                ...
                string DirName = Path.Combine(FullXmlPath, updatedXMLFile);
                string TarFile = FullXmlPath + ".tar.gz";
                if (File.Exists(TarFile))
                {
                    File.Delete(TarFile); //CreateTar(TarFile, XMLPath);
                    //CreateTar(TarFile, DestDir);
                    //CreateTarGZ(TarFile, DestDir);
                }
                else
                {
                    //CreateTarGZ(TarFile, XMLPath);
                    //CreateTar(TarFile, XMLPath);
                }
                //if (File.Exists(ZipFileName))
                //{
                //    File.Delete(ZipFileName);
