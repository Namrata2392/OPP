    ...
    public class DerivedDI
    {
        ...
        public DerivedDI()
        {
            ...
            try
            {
                ...
                ucdd.lvDD.SelectedIndexChanged += new System.EventHandler(this.lvDD_SelectedIndexChanged);
                ucdd.lvDD.ItemSelectionChanged += new System.Windows.Forms.ListViewItemSelectionChangedEventHandler(this.lvDD_ItemSelectionChanged);
                addListHeaders();
                fillOptions();
            }
            catch (Exception ex)
        ...
        public static Bitmap MergeTwoImages(Image firstImage, Image secondImage, bool resizeToMinHeight = false)
        {
            if (resizeToMinHeight)
            {
                if (firstImage.Height > secondImage.Height)
                    firstImage = ResizeImage(firstImage, secondImage.Height);
                else
                    secondImage = ResizeImage(secondImage, firstImage.Height);
            }
        ...
        public static Bitmap ResizeImage(Image image, int targetheight)
        {
            float scale = (float)targetheight / (float)image.Height;
            return new Bitmap(image, (int)(image.Width * scale), (int)(image.Height * scale));
        }
        private void lvDD_ItemSelectionChanged(object sender, ListViewItemSelectionChangedEventArgs e)
        {
            if (ucdd.lvDD.SelectedItems.Count != 0)
            {
                int ListIndex = ucdd.lvDD.FocusedItem.Index;
                ListViewItem lvi = ucdd.lvDD.Items[ListIndex];
                ucdd.txtDI1.Text = lvi.SubItems[1].Text;
                ucdd.txtDI2.Text = lvi.SubItems[2].Text;
                ucdd.txtDI3.Text = lvi.SubItems[3].Text;
                ucdd.txtDI4.Text = lvi.SubItems[4].Text;
                ucdd.txtDI5.Text = lvi.SubItems[5].Text;
                ucdd.txtDI6.Text = lvi.SubItems[6].Text;
                ucdd.txtDI7.Text = lvi.SubItems[7].Text;
                ucdd.txtDI8.Text =lvi.SubItems[8].Text;
                ucdd.txtDI9.Text = lvi.SubItems[9].Text;
                ucdd.txtDI10.Text = lvi.SubItems[10].Text; 
                ucdd.txtDelay.Text = lvi.SubItems[12].Text;
                string strLogicGate = lvi.SubItems[11].Text;

                switch (strLogicGate.ToUpper())
                {
                    case "AND":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("AND"));
                        break;
                    case "NOT":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("NOT"));
                        break;
                    case "OR":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("OR"));
                        break;
                    case "XOR":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("XOR"));
                        break;
                    case "NOR":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("NOR"));
                        break;
                    case "NAND":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("NAND"));
                        break;
                    case "XNOR":
                        ucdd.pictureBox2.Image = new Bitmap((Image)Properties.Resources.ResourceManager.GetObject("XNOR"));
                        break;
                    default:
        ...
        private void lvDD_SelectedIndexChanged(object sender, EventArgs e)
        {
            string strRoutineName = "DerivedDI:lvDD_SelectedIndexChanged";
            try
            {
                //string ListIndex = ucdd.lvDD.FocusedItem.Text;
                //int ListIndex = ucdd.lvDD.FocusedItem.Index;
                //ListViewItem lvi = ucdd.lvDD.Items[ListIndex];
                ...
                //ucdd.txtDI8.Text = (lvi.SubItems[8].Text);
                //ucdd.txtDI9.Text = (lvi.SubItems[9].Text);
                //ucdd.txtDI10.Text = (lvi.SubItems[11].Text);
                //ucdd.txtDelay.Text = (lvi.SubItems[11].Text);
                //string strLogicGate = (lvi.SubItems[12].Text);
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (mode == Mode.ADD)
                {
                    ...
                    //Namrata: 30/01/2020
                    ucdd.splitContainer1.Panel2Collapsed = false;
                    ucdd.txtDI1.Text = (ddList[ddList.Count - 1].DINo1);
                    ucdd.txtDI2.Text = (ddList[ddList.Count - 1].DINo2);
                    ucdd.txtDI3.Text = (ddList[ddList.Count - 1].DINo3);
                    ucdd.txtDI4.Text = (ddList[ddList.Count - 1].DINo4);
                    ucdd.txtDI5.Text = (ddList[ddList.Count - 1].DINo5);
                    ucdd.txtDI6.Text = (ddList[ddList.Count - 1].DINo6);
                    ucdd.txtDI7.Text = (ddList[ddList.Count - 1].DINo7);
                    ucdd.txtDI8.Text = (ddList[ddList.Count - 1].DINo8);
                    ucdd.txtDI9.Text = (ddList[ddList.Count - 1].DINo9);
                    ucdd.txtDI10.Text = (ddList[ddList.Count - 1].DINo10);
                    ucdd.txtDelay.Text = (ddList[ddList.Count - 1].DelayMS);
                    string strLogicGate = (ddList[ddList.Count - 1].Operation);
                    ...
                    #region Commented Code for merge picturebox
                    //Image img1 = Image.FromFile(ucdd.pictureBox1.Image);
                    //Image img2 = Image.FromFile(@"D:\ASHIDA RelayTalk V2\ASHIDARelayTalk\Resources\AND.png");
                    //Bitmap bm = MergeTwoImages(img1, img2, true);
                    //ucdd.pictureBox1.Image= MergeTwoImages(img1, img2, true);
                    //ucdd.pictureBox1.Image = new Bitmap(@"C:\Users\namrata\Desktop\New folder\GateLogic.png");
                    //ucdd.pictureBox2.Image = new Bitmap(@"D:\ASHIDA RelayTalk V2\ASHIDARelayTalk\Resources\AND.png");
                    //Size s = new Size(ucdd.pictureBox1.Image.Width + ucdd.pictureBox2.Image.Width-50, Math.Max(ucdd.pictureBox1.Image.Height, ucdd.pictureBox2.Image.Height));

                    //Bitmap bmp = new Bitmap(s.Width, s.Height);
                    //using (System.Drawing.Graphics g = System.Drawing.Graphics.FromImage(bmp))
                    //{
                    //    g.DrawImage(ucdd.pictureBox1.Image, 0, 0);
                    //    g.DrawImage(ucdd.pictureBox2.Image, ucdd.pictureBox1.Image.Width, 0);

                    //}

                    //ucdd.pictureBox3.Size = bmp.Size;
                    //ucdd.pictureBox3.Image = bmp;
                    #endregion Commented Code for merge picturebox
                }
                else if (mode == Mode.EDIT)
                {
                    ...
                    ucdd.splitContainer1.Panel2Collapsed = false;
                    ucdd.txtDI1.Text = (ddList[editIndex].DINo1);
                    ucdd.txtDI2.Text = (ddList[editIndex].DINo2);
                    ucdd.txtDI3.Text = (ddList[editIndex].DINo3);
                    ucdd.txtDI4.Text = (ddList[editIndex].DINo4);
                    ucdd.txtDI5.Text = (ddList[editIndex].DINo5);
                    ucdd.txtDI6.Text = (ddList[editIndex].DINo6);
                    ucdd.txtDI7.Text = (ddList[editIndex].DINo7);
                    ucdd.txtDI8.Text = (ddList[editIndex].DINo8);
                    ucdd.txtDI9.Text = (ddList[editIndex].DINo9);
                    ucdd.txtDI10.Text = (ddList[editIndex].DINo10);
                    ucdd.txtDelay.Text = (ddList[editIndex].DelayMS);
                    //ucdd.lblGate.Text = (ddList[editIndex].Operation);
                    string strLogicGate = (ddList[editIndex].Operation);
