...
namespace OpenProPlusConfigurator
{
    ...
    */
    public partial class ucDerivedDI : UserControl
    {
        ...
        public event EventHandler lvDDSelectedIndexChanged;
        public event ListViewItemSelectionChangedEventHandler lvDDItemSelectionChanged;
        public ucDerivedDI()
        {
            InitializeComponent();
        ...
        {
                if (lvDDSelectedIndexChanged != null)
                lvDDSelectedIndexChanged(sender, e);
        }
        ...
        private void ucDerivedDI_Load(object sender, EventArgs e)
        {
        ...
        {
                if (lvDDItemSelectionChanged != null)
                lvDDItemSelectionChanged(sender, e);
        }
